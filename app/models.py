...
class User(UserMixin, db.Model):
    ...
    initiated_deployments = db.relationship('KeyDeployment', foreign_keys='KeyDeployment.deployed_by', backref='deployer')
    initiated_revokes = db.relationship('KeyDeployment', foreign_keys='KeyDeployment.revoked_by', backref='revoker')
